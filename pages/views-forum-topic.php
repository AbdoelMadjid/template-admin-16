			...
			<div class="col-sm-12">
				...
				<div class="well">
					...
					<table class="table table-striped table-forum">
						<thead>
							<tr>
								<th colspan="2"><a href="?page=views-forum"> Projects </a> > Business Requirement Docs</th>
						...
						<tbody>
							...
							<tr class="warning">
								...
								<td>
									<h4><a href="?page=views-forum-post">
										Welcome message
									</a>
										<small><a href="?page=views-profile">John Doe</a> on <em>January 1, 2014</em></small>
									</h4>
								</td>
